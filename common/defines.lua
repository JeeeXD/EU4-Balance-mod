...
NDiplomacy = {
	...
	EMPEROR_VOTE_DAYS = 0,	 						-- _DDEF_EMPEROR_VOTE_DAYS_; "Cooldown" until Electors can change their vote again.
	...
	MIN_RELATIONS_TO_ALLY = -250,						-- Alliances not possible if either country has an opinion of the other lower than this
	MIN_RELATIONS_TO_SUPPORT_INDEPENDENCE = -250,	-- Support Independence not possible if either country has an opinion of the other lower than this
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_DEVASTATION = -5,	-- Yearly change of Mandate for each hundred devastated development (scaled to devastation).
	...
	CELESTIAL_EMPIRE_MANDATE_PER_5_LOANS = -0.06,	-- Yearly change of Mandate for every 5 loans.
	...
	IMPERIAL_CITY_IA = 0,						-- Monthly per imperial free city
	...
	LEAVE_HRE_AUTHORITY_PER_DEVELOPMENT = -0.01,
...
NCountry = {
	...
	DISHONOURED_ALLIANCE_DURATION = 0,
	...
	RAZE_PROVINCE_POWER_PER_DEVELOPMENT = 15.0,
...
NEconomy = {
	...
	TRADE_NON_CAPITAL_OFFICE = -0.33,				-- TRADE_NON_CAPITAL_OFFICE
	...
	CONSTRUCT_IN_SUBJECT_TIME_MULTIPLIER = 1,
...
NMilitary = {
	SLACKEN_AP_DROP = 0.013,							--Defines how much AP is lost when activating slacken toggle.
	...
	SLACKEN_MAX_MP_PERCENTAGE = 0.9,   			--Defines how much manpower percentage of your whole manpower pool you can have before the toggle turns off automatically. "1" would mean "100% of your manpower pool". Put a -1 here if you don't want this toggle to turn off from having manpower
	...
	PARTICIPATION_SCORE_BATTLE = 0.04,				-- Per regiment or ship engaged in battle
	...
	ARMY_ATTRITION_AT_SEA = 3,						-- How many percent attrition units take while loaded onto ships traveling open sea
	...
	ASSAULT_ATTACKER_LOSS = 1.5, 					-- MDEF_ASSAULT_ATTACKER_LOSS = 10,
	...
	REBEL_RELOCATION_TIME = 0.2,						-- How long time it takes for rebels to relocate from island
	REBEL_RELOCATION_DISTANCE_MAX = 2000,					-- The maximum distance rebels will relocate to.
	...
	WARDEC_COBELLI_FOR_DEFENDER_OF_THE_FAITH = 0,
...
NAI = {
	...
	ACCEPTABLE_BALANCE_DEFAULT = 1, --AI wants this advantage to enter battles typically. (There are some exceptions, e.g. offensives.)
	ACCEPTABLE_BALANCE_MULT_FRIEND_IN_COMBAT = 0.5,
	...
	DEVELOP_IN_SUBJECTS_PREFERENCE = 0, -- At 1, AI likes developing subjects approximately the same as its own provinces (more or less depending on their Liberty Desire).
	...
	DIPLOMATIC_ACTION_GUARANTEE_POWERBALANCE_FACTOR = 0, --AI scoring for guarantee action is increased by this if a nation blocks a powerbalance threat.
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_AI = 0, --AI willingness to send gifts to AI nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_GIFT_POWERBALANCE_FACTOR_PLAYER = 0, --AI willingness to send gifts to human nations fighting power balance threat is modulated by this.
	DIPLOMATIC_ACTION_SUBSIDIES_POWERBALANCE_FACTOR = 0, --AI scoring to give subsidies to nations blocking/fighting power balance threat.
	DIPLOMATIC_ACTION_CRUSADE_POWERBALANCE_FACTOR = 100, --AI scoring for calling crusade on power balance threat.
	DIPLOMATIC_ACTION_EXCOMMUNICATE_POWERBALANCE_FACTOR = 100, --AI scoring for excommunicating power balance threat.
	...
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_ALLY_FACTOR = 0, --AI additional scoring for Take on Foreign Debt with nations we are allied to.
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_POWERBALANCE_FACTOR = 0, --AI additional scoring for Take on Foreign Debt for targets that block powerbalance threat.
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_ANTI_RIVAL_FACTOR = 0, --AI additional scoring for Take on Foreign Debt for targets that block at least one rival.
	DIPLOMATIC_ACTION_TAKE_ON_DEBT_MONTHLY_INCOME = 0, --Limit on number of months of income AI wants to spend on a single Take on Foreign Debt action.
	DIPLOMATIC_ACTION_INFLUENCE_NATION_BASE_FACTOR = 0, -- AI base scoring for Influence Nation (needs to be ally or block rival/power balance threat to even apply).
	DIPLOMATIC_ACTION_INFLUENCE_NATION_ALLY_FACTOR = 0, --AI additional scoring for Influence Nation with nations we are allied to.
	DIPLOMATIC_ACTION_INFLUENCE_NATION_POWERBALANCE_FACTOR = 0, --AI additional scoring for Influence Nation for targets that block powerbalance threat.
	DIPLOMATIC_ACTION_INFLUENCE_NATION_ANTI_RIVAL_FACTOR = 0, --AI additional scoring for Influence Nation for targets that block at least one rival.
	DIPLOMATIC_ACTION_INFLUENCE_NATION_MONTHLY_INCOME = 0, --Limit on number of months of income AI wants to spend on a single Influence Nation action.
	...
	SUBSIDY_YEARS = 0, -- Years AI will give subsidies for
	MIN_INCOME_FOR_SUBSIDIES = 1000, -- Minimum monthly income for AI to want to spend some on subsidies
	PS_SHORT_TERM_POOL = 0, -- Max power AI will store in its short-term spending pool
	AGGRESSIVENESS = 10000, -- Base chance (out of 10000) of AI being willing to start a war each diplomatic tick (~1.5 times a month)
	AGGRESSIVENESS_BONUS_EASY_WAR = 10000, -- Added to aggressiveness if the war is against a weak or particularily hated enemy
	...
	DESIRED_SURPLUS = 0, -- AI will aim for having at least this fraction of their income as surplus when they don't have large savings
	DESIRED_DEFICIT = 0, -- AI will try to spend this fraction of their money above their target for long term savings.
	EXTRA_SURPLUS_WHEN_NEEDING_BUILDINGS = 0, -- AI will aim for having at least this fraction of their income as additional surplus when they need buildings
	MAX_SAVINGS = 0, -- AI will keep a maximum of this * their monthly income in long-term savings
	BUDGET_STEAL_THRESHOLD = 10.0, -- AI will move budget from one area to another if its priority is this many times as high.
	ADVISOR_BUDGET_FRACTION_MAX = 0.9, -- AI will spend a maximum of this fraction of monthly income on advisor maintenance
	ADVISOR_BUDGET_FRACTION_MIN = 0.3, -- AI will spend a minimum of this fraction of monthly income on advisor maintenance
	...
	ARMY_BUDGET_FRACTION = 2, -- AI will spend a maximum of this fraction of monthly income on army maintenance (based off wartime costs)
	...
	FORCE_MARCH_ALWAYS_SIZE = 80, -- AI will always try to force march units of at least this size (disabled)
	MAX_BUILDING_COST_INCOME_MONTHS = 1, -- AI will not save up for a building that costs more than their monthly income * this, if there are cheaper alternatives
	PURSUE_DISTANCE = 100, -- AI will not pursue armies retreating to a province further away than this
	CALL_IN_ALLIES_POWER_RATIO = 100, -- AI will only call in allies in an offensive war if their military power ratio to the enemy is less than this
	...
	DANGEROUS_OVEREXTENSION_PERCENTAGE = 1,
	...
	PEACE_HIGH_WAR_EXHAUSTION_THRESHOLD = 20, -- Threshold for when PEACE_HIGH_WAR_EXHAUSTION_FACTOR is applied
	PEACE_HIGH_WAR_EXHAUSTION_FACTOR = 0, -- Additional AI willingness to peace based on war exhaustion above the high threshold
	...
	PEACE_WARGOAL_FACTOR = 15, -- AI unwillingness to peace based on holding the wargoal
	...
	PEACE_TERMS_PROVINCE_BASE_MULT = 1.75,
	PEACE_TERMS_TRADE_POWER_BASE_MULT = 0.0,
	PEACE_TERMS_HUMILIATE_BASE_MULT = 0.0,
	PEACE_TERMS_REVOKE_CORES_BASE_MULT = 0.0,
	PEACE_TERMS_REVOKE_REFORM_BASE_MULT = 0.0,
	PEACE_TERMS_RETURN_CORES_BASE_MULT = 0.0,
	PEACE_TERMS_RELEASE_VASSALS_BASE_MULT = 0.0,
	PEACE_TERMS_TRANSFER_VASSALS_BASE_MULT = 0.0,
	PEACE_TERMS_RELEASE_ANNEXED_BASE_MULT = 0.75,
	PEACE_TERMS_ANNUL_TREATIES_BASE_MULT = 0.0,
	PEACE_TERMS_GOLD_BASE_MULT = 3,
	PEACE_TERMS_GIVE_UP_CLAIM = 0.0,
	PEACE_TERMS_GIVE_UP_CLAIM_PERMANENT = 0.0,
	PEACE_TERMS_CONCEDE_DEFEAT_BASE_MULT = 0.0,
	...
	DIPLOMATIC_ACTION_OFFER_CONDOTTIERI_BASE_MULT = 0, -- AI scoring for offer condottieri, base scale.
	...
	INVADING_BRAVERY = 0,									-- If (defender strength) / (invader strength) > INVADING_BRAVERY, the AI won't attempt a naval invasion
	INVADING_MAX_AWAY_RATIO = 0,							-- AI will never send more than this ratio to invade (Measured in strength)
	INVASION_FLEET_DISTANCE_PENALTY = 1,					-- Lower number makes AI more likely to select ships far away for transports
	...
	FIRE_ADVISOR_LOAN_REQUIREMENT = 9,							-- AI will not fire advisors until it has this many loans
	...
	RECRUIT_ADVISOR_BASE_AI_DESIRE = 1000.0,						-- AI scoring for redruiting advisors, multiplied by budget/cost
	PROMOTE_ADVISOR_BASE_AI_DESIRE = 1000.0,						-- AI scoring for promoting advisors, multiplied by budget/cost
	...
	REPAY_LOAN_BASE_AI_DESIRE = 1.0,							-- AI scoring for repaying loans, multiplied by (MAX(budget - other loans, 0) * number_of_loans)/cost
	...
	ESTATE_MAX_WANTED_INFLUENCE = 90.0,
	...
	MIN_DAYS_AFTER_TRUCE_ENDS = 1, -- How long AI needs to wait after a truce ends to declare a war, some time needed for the player to take any action since AI can do it immediately
},
...
NAIEconomy = {
	...
	MILITARY_FOCUS_DEFAULT = 2.0,
	MILITARY_FOCUS_LOWER_BOUND = 2.0,
	MILITARY_FOCUS_UPPER_BOUND = 4.0,
	ARMY_FRACTION_MILITARIZE = 2.0,
	ARMY_FRACTION_PEACEFUL = 1,
	ARMY_FRACTION_MILITARIST = 2.0,
	NAVY_FRACTION_PEACEFUL = 1,
	NAVY_FRACTION_CAPITALIST = 1,
	FORT_FRACTION_MILITARIZE = 2,
	FORT_FRACTION_MILITARIST = 2,
	FORT_FRACTION_CAPITALIST = 2,
	MISSIONARY_FRACTION = 0.15,
	STATE_MAINTENANCE_FRACTION = 0.1,
	BASE_SAVINGS_PRIORITY = 0.1,
	BASE_SAVINGS_PRIORITY_WARTIME = 0.0,
	LOAN_REPAYMENT_SAVINGS_PRIORITY = 1.0,				-- Per loan
	LOAN_REPAYMENT_SAVINGS_PRIORITY_WARTIME = 0,		-- Per loan
	SUBSIDY_PRIORITY_CONSIDERATION_THRESHOLD = 50.0,
	SUBSIDY_DESIRE_TO_PRIORITY_RATIO = 0.05,
	SUBSIDY_MAX_BUDGET_FRACTION = 0,
},
...
NReligion = {
	...
	MIN_CARDINALS = 10,											-- Least amount of cardinals/ Starting cardinals
